...
export const eventState = pgTable(
	'event_state',
	{
		...
		phaseA: eventPhaseEnum('phase_a').notNull().default('setup'),
		phaseB: eventPhaseEnum('phase_b').notNull().default('setup'),
		phaseC: eventPhaseEnum('phase_c').notNull().default('setup'),
		sprintStartA: timestamp('sprint_start_a', { withTimezone: true }),
		sprintStartB: timestamp('sprint_start_b', { withTimezone: true }),
		sprintStartC: timestamp('sprint_start_c', { withTimezone: true }),
