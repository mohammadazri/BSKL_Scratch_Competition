<!--
	/admin/requests — review queue for judge edit-access requests.
	Two columns: pending requests with Approve/Deny actions, and a resolved
	history below.
-->
<script lang="ts">
	...
	import { CheckCircle2, XCircle, Inbox } from '@lucide/svelte';
	import type { ActionData, PageData } from './$types';
	import type { EditRequestRow } from './+page.server';
...
<!-- Pending -->
<Card label="Pending ({pending.length})">
	{#if pending.length === 0}
