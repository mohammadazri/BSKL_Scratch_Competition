...
- Zero Trust dashboard → Access → Applications → add `p3.sentrizk.me`
...
- [ ] Public URL `https://p3.sentrizk.me` loads the app from outside the network
