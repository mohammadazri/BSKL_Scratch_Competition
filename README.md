...
Production runs on a **Raspberry Pi 4 (4GB+) or Pi 5** with **Cloudflare Zero Trust Tunnel** exposing the app at `https://judging.<your-domain>.com`. No port forwarding, free TLS, optional email-allowlist via Cloudflare Access.
